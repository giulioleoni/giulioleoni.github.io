...
export default function Form() {
    ...
    const sendEmail = (params) => {
        ...
        emailjs.send(
                ...
                params,
                {
                    ...
                    limitRate: {
                        throttle: 5000,       // you cannot sent more than 1 email per 5 seconds
                    }
                }
            )
            .then(
    ...
    return (
        ...
        >
            ...
            />
            {
                errors.email && <span className='inline-block self-start text-accent border-current'>{errors.email.message}</span>
            }
